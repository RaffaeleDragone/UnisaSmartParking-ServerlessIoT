...
import static rest.RunSmartParkingRest.HOST_MONGODB;
import static rest.RunSmartParkingRest.PORT_MONGODB;
import static rest.RunSmartParkingRest.DB_NAME;

public class ConnectionPool {

    private static MongoClient mongoClient = new MongoClient(HOST_MONGODB,PORT_MONGODB);
